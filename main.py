...
<div class="subtitle">Choose your learning duration and continue to secure payment.</div>  <form method="POST" action="/create-payment">  
...
{% endfor %}  <button type="submit">💳 CONTINUE TO SECURE PAYMENT</button>
...
<head>  
<meta name="viewport" content="width=device-width, initial-scale=1">  
<title>Connect Telegram</title>  <style>  
body{  
...
</style>  <script async src="https://telegram.org/js/telegram-widget.js?22"  
...
<div class="container">  <h1>🔗 Connect Your Telegram</h1>  <div class="info">  
...
<head>  
<meta name="viewport" content="width=device-width, initial-scale=1">  
<title>ALHIKAM Student Registration</title>  <style>  
...
<div class="container">  <h1>🎓 ALHIKAM Learning Center</h1>  <div class="info">  
<strong>Payment Confirmed ✅</strong><br><br>  
Plan: {{ plan_name }}<br>  
Amount: ₦{{ "{:,}".format(amount) }}  
...
<input type="hidden" name="csrf_token" value="{{ csrf_token }}">  <label>Full Name</label>
...
</select>  <button type="submit">✅ COMPLETE REGISTRATION</button>
