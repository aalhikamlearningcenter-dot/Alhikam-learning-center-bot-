...
<div class="info">Enter your referral code and promoter password.

</div><form method="POST"
      action="{{ url_for('promoter_login') }}"><input
type="hidden"
name="csrf_token"
value="{{ csrf_token }}"
...
</script></head><body><div class="container"><div class="header"><div><h1>
🎓 ALHIKAM Learning Center
</h1><div class="small">
Promoter Dashboard
</div></div><form method="POST"
      action="{{ url_for('promoter_logout') }}"><input
type="hidden"
name="csrf_token"
value="{{ csrf_token }}"
...
<!-- STATS --><div class="card"><h2>
📊 My Performance
</h2><div class="stats"><div class="stat"><div class="stat-title">
Total Sales
...
</div></div></div></div><!-- REFERRAL INFORMATION --><div class="card"><h2>
🔗 My Referral Link
</h2><p class="small">Share this link with students.
...
{{ promoter["referral_code"] }}
</span></div><!-- DIRECT PAYMENT LINK --><div class="card"><h2>
💳 Direct Payment Link
</h2><p class="small">Students can use this link directly to open
the payment page.
...
</div></div><!-- WITHDRAW --><div class="card"><h2>
💰 Withdraw Commission
</h2><div class="warning"><strong>
Withdrawal Security
</strong><br><br>
...
</div><p class="small">Minimum withdrawal:

<strong>
₦{{ "{:,.2f}".format(minimum_withdrawal) }}
</strong></p><!-- IMPORTANT:
     The correct main.py endpoint is referral_withdraw.
--><form method="POST"
      action="{{ url_for('referral_withdraw') }}"><input
type="hidden"
name="csrf_token"
value="{{ csrf_token }}"
...
</form></div><!-- WITHDRAWAL HISTORY --><div class="card"><h2>
📜 Withdrawal History
</h2><div class="table-wrap"><table><thead><tr><th>ID</th>
<th>Amount</th>
<th>Bank</th>
<th>Account</th>
<th>Status</th>
...
<th>Created</th>
<th>Action</th></tr></thead><tbody>{% for withdrawal in withdrawals %}
...
</style></head><body><div class="container"><div class="card"><h1>
💰 Withdrawal Status
</h1><div class="item"><strong>
Withdrawal ID
</strong><br>{{ withdrawal["id"] }}

</div><div class="item"><strong>
Amount
</strong><br>₦{{ "{:,.2f}".format(
withdrawal["amount"] or 0
) }}
...
Bank
</strong><br>{{ withdrawal["bank_name"] or "" }}

</div><div class="item"><strong>
Account
</strong><br>{{ mask_account(
withdrawal["account_number"]
) }}

</div><div class="item"><strong>
Status
</strong><br><div class="status">
{{ withdrawal["status"] or "" }}
</div></div><div class="item"><strong>
Transfer Status
</strong><br>{{ withdrawal["transfer_status"] or "" }}

</div><div class="item"><strong>
Transfer Reference
</strong><br>{{ withdrawal["transfer_reference"] or "" }}

</div>{% if withdrawal["transfer_message"] %}

<div class="item"><strong>
Message
</strong><br>{{ withdrawal["transfer_message"] }}
